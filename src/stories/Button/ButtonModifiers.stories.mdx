...
<Canvas>
	<Story name="block" play={testBlockButton}>
		{() => {
			return {
				components: { VvButton },
				template:
...
<Canvas>
	<Story name="rounded" play={testBlockButton}>
		{() => {
			return {
				components: { VvButton },
				template:
...
<Canvas>
	<Story name="disabled" play={testDisabledButton}>
		{() => {
			return {
				components: { VvButton },
				template:
...
<Canvas>
	<Story name="active" play={testBlockButton}>
		{() => {
			return {
				components: { VvButton },
				template:
